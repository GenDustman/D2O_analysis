...
def main():
    ...
    if all_tv_muon_h:
        ...
        plot_normalized_histogram_comparison(
            ...
            img_path=height_img_path, title=f'Master Thin Veto Height Comparison - {agg_label}',
        ...
        plot_normalized_histogram_comparison(
            ...
            img_path=area_img_path, title=f'Master Thin Veto Area Comparison - {agg_label}',
