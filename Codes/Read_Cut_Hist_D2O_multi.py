...
def plot_histogram(arrays, labels, bins, img_path, title, xlabel,
    ...
    pickle_data = {'centers': centers, 'histograms': {label: counts for label, (counts, edges) in zip(labels, outputs)}}
...
def main():
    ...
    # The output directory for this specific sub-job's results
